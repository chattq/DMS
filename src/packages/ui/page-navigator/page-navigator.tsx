...
export const PageNavigator = forwardRef(({ currentPage, totalPages, onPreviousPage, onNextPage }: PageNavigatorProps, ref: any) => {
  return (
    <div ref={ref} className={'page-navigator min-w-fit flex items-center'}>
      ...
      <div className={'page-navigator__current-page w-full flex items-center justify-between'}>
        <div
