...
export default function CustomColumnChooser(props: CustomColumnChooserProps) {
    const { container, button, visible, columns, onHiding, onApply, applyText, cancelText, title, selectAllText } = props;
        ...
        return {
            ...
            onClick: () => {
                ...
                columns.forEach((column) => {
                    let isSelected = selectedItems?.includes(captionize(column.dataField));
